...
import com.example.LearnSpringboot.github.GithubClient;
...
public class EventsController {
    ...
    private final GithubProjectRepo repository;

    public EventsController(GithubClient githubClient, GithubProjectRepo repository) {
